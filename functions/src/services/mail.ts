...
// confirmEmail
export const sendConfirmationEmail = async (email: string, displayName: string) => {
  const mailOptions = {
    ...
    html: `
            <div>
                ...
                <p>Hi ${displayName},</p>
                <p>Thanks for signing up for Promovize! We're excited to have you as an early user.</p>
